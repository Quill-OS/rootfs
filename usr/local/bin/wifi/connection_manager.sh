...
# (NOTE: Not only dhd.ko causes this problem; 8189fs + Clara HD & 8723ds + Libra 2 makes it happen as well)
if [ "${DEVICE}" == "n905c" ] || [ "${DEVICE}" == "n437" ] || [ "${DEVICE}" == "n418" ] || [ "${DEVICE}" == "n249" ]; then
